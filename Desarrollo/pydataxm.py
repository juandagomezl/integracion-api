...
class ReadDB:
    ...
    def request_data(self, coleccion, metrica, start_date, end_date):
        ...
        # Check coleccion belongs to inventario
        ...
        # Request CapEfectNeta Daily (1 day)
...
if __name__ == "__main__":
    consult = ReadDB()
    df1 = consult.request_data("Gene", 1, dt.date(2020, 7, 1), dt.date(2020, 9, 10))